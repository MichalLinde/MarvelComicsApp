...
@Composable
fun HomeScreen(comicBook: ComicBook) {
    val bottomSheetScaffoldState = rememberBottomSheetScaffoldState(
        bottomSheetState = BottomSheetState(BottomSheetValue.Collapsed)
    )
    val uriHandler = LocalUriHandler.current
    var authors = "No author was given :("
    if (comicBook.creators.items.isNotEmpty()) {
        ...
        var description = "Sorry, no description was given :("
        ...
        BottomSheetScaffold(
            sheetShape = RoundedCornerShape(topStart = dimensionResource(id = R.dimen.find_more_button_corner_radius),
